...
- Create Angular project with ng: `ng new voyadosearchengine.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`voyadosearchengine.client.esproj`).
